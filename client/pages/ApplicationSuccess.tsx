...
export default function ApplicationSuccess() {
  ...
  const texts = {
    ...
    bn: {
      ...
      step1Desc:
        "আবেদনকারী পোর্টাল অ���যাক্সেস করতে আপনার আবেদনকারী আইডি এবং অস্থায়ী পাসওয়ার্��� ব্যবহার করুন",
      ...
      saveInfoDesc:
        "অনুগ্রহ করে আপনার আবেদনকার�� আইডি এবং পাসওয়ার্ড সংরক্ষণ করুন। আবেদনকারী পোর্টাল অ্যাক্সেস করতে আপনার এগুলি প্রয়োজন হবে।",
