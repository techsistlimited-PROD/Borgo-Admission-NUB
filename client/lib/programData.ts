...
export const waiverPolicies: WaiverPolicy[] = [
  // Result-based Waivers
  {
    ...
    criteriabn: "এসএসসি ও এইচএসসি উভয়ে ৪র্থ বিষয় ছাড়া জি��িএ ৫.০০",
  ...
  {
    id: "extracurricular",
    name: "Extracurricular Activities Waiver",
    namebn: "বহির্ভাগীয় কার্যক্রম মওকুফ",
    type: "special",
    percentage: 30,
    criteria: "Extracurricular points >= 80",
    criteriabn: "বহির্ভাগীয় কার্যক্রম পয়েন্ট ≥ ৮০",
    description: "Waiver for students with strong extracurricular achievements",
    descriptionbn: "উচ্চ বহির্ভাগীয় কার্যক্রম অর্জনকারী শিক্ষার্থীদের জন্য মওকুফ",
  },
  {
    id: "sibling",
    name: "Sibling Waiver",
