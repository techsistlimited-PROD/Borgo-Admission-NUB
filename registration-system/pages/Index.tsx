...
export default function RegistrationIndex() {
  ...
  const texts = {
    en: {
      ...
      admissionSystem: "← Back to Admission System",
    },
    bn: {
      ...
      scheduleManagement: "সময়সূচী ব্���বস্থাপনা",
      getStarted: "শুরু করুন",
      selectRole: "চালিয়ে যেতে আপনার ভূমিকা নির্বাচন করুন:",
      admissionSystem: "← ভর্তি সিস্টেমে ফিরুন",
    },
  };
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            ...
            {/* Right side with back link and language toggle */}
            <div className="flex items-center gap-4">
              {/* Back to Admission System */}
              <a
                href="/"
                className="text-deep-plum hover:text-accent-purple transition-colors text-sm font-medium"
              >
                {t.admissionSystem}
              </a>
