...
import { LogOut, Users, CheckCircle, Clock, AlertCircle } from "lucide-react";
            ...
            <div className="space-y-4">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
                    <p className="font-medium">Student {i}: 2021-1-60-{String(i).padStart(3, '0')}</p>
                    <p className="text-sm text-gray-600">Registered for 5 courses (15 credits)</p>
                  </div>
