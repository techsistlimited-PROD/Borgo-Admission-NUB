...
const supabaseUrl = process.env.SUPABASE_URL || 'https://lpjwyilcjogxdxvvqzsh.supabase.co';
const supabaseServiceRoleKey = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imxwand5aWxjam9neGR4dnZxenNoIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NTQzODM5MywiZXhwIjoyMDcxMDE0MzkzfQ.gMkzl9y0pdbp_vQheWcm-SMkvEPl1u60s_AhzVoAmkk';
